      ...
      <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="flex flex-col gap-y-4">
          ...
          <div className="flex items-center gap-x-4">
            <a href="https://github.com/KrishKuChhabra" target="_blank">
              <span className="socialLink">
                <BsGithub />
              </span>
            </a>
            <a href="https://www.linkedin.com/in/krishchhabra25/" target="_blank">
              <span className="socialLink">
                <BsLinkedin />
              </span>
            </a>
            <a href="https://twitter.com/KrishChhabra25" target="_blank">
              <span className="socialLink">
                <BsTwitter />
              </span>
            </a>
